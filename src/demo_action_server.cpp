...
#include "master_ros/Demo_actionAction.h"
#include <iostream>
#include <sstream>
using namespace std;
...
protected:
    ros::NodeHandle nh_;
    // NodeHandle instance must be created 
    actionlib::SimpleActionServer<master_ros::Demo_actionAction> as;
    master_ros::Demo_actionFeedback feedback;
    master_ros::Demo_actionResult result;
    ...
    ~Demo_actionAction(void)
{
    ...
    void executeCB(const master_ros::Demo_actionGoalConstPtr &goal)
